    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Building peaceful, intelligent and connected digital solutions for a global future.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                <Mail size={16} />
                <span>arshad.ali0708116@Paxelus.com</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={16} />
                <span>+92 (345) 170-3658</span>
              </li>
              <li className="flex items-center gap-2">
                <MapPin size={16} />
                <span>Lahore, PK</span>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Paxelus Tech. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
